...
from defensegan_datasets.celeba import CelebA
from defensegan_datasets.fmnist import FMnist
from defensegan_datasets.mnist import Mnist
...
def get_generators(dataset_name, batch_size, randomize=True, attribute='gender'):
    """Creates batch generators for defensegan_datasets.
