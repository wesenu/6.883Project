...
"""Contains the classes:
 Dataset: All defensegan_datasets used in the project implement this class.
...
class Dataset(object):
    """The abstract class for handling defensegan_datasets.
    ...
    def __init__(self, name, data_dir='./data'):
        """The datasaet default constructor.
            ...
            Args:
                ...
                data_dir (optional): The path of the defensegan_datasets on disk.
        """
