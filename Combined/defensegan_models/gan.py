...
import defensegan_tflib
import defensegan_tflib.cifar10
import defensegan_tflib.mnist
import defensegan_tflib.plot
import defensegan_tflib.save_images
from defensegan_datasets.defensegan_utils import get_generators
from defensegan_models.base_model import AbstractModel
from defensegan_models.dataset_defensegan_models import mnist_generator, celeba_discriminator, \
    mnist_discriminator, celeba_generator
from defensegan_utils.misc import ensure_dir
from defensegan_utils.visualize import save_images_files
...
class DefenseGANBase(AbstractModel):
    ...
    def _loss(self):
        ...
        if self.mode == 'wgan':
            ...
            clip_ops = []
            for var in defensegan_tflib.params_with_name('Discriminator'):
                clip_bounds = [-.01, .01]
                clip_ops.append(
                    tf.assign(
                        var,
    ...
    def _generate_image(self, training_iter):
        ...
        defensegan_tflib.save_images.save_images(
    ...
    def train(self, phase=None):
        ...
        for iteration in xrange(cur_iter, max_train_iters):
            ...
            defensegan_tflib.plot.plot('{}/train disc cost'.format(self.debug_dir),
                            _disc_cost)
            defensegan_tflib.plot.plot('{}/time'.format(self.debug_dir),
            ...
            if iteration % 100 == 5:
                ...
                defensegan_tflib.plot.plot('{}/dev disc cost'.format(self.debug_dir),
