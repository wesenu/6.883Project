...
"""Contains the abstract class for defensegan_models."""
...
from defensegan_utils.dummy import DummySummaryWriter


class AbstractModel(object):
    def __init__(self, default_properties, test_mode=False, verbose=True,
                 cfg=None, **args):
        """The abstract model that the other defensegan_models extend.
    ...
    def load(self, checkpoint_dir=None, prefixes=None, saver=None):
        ...
        Args:
            checkpoint_dir: The path to saved defensegan_models
        """
        if prefixes is None:
